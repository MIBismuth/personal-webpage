...
We can compare the pros and cons of the JavaScript vs Python implementations.
...
In the process, I ended up adding a lot of technologies that were frankly useless for my use case, like TypeScript. My brothers, even today I don't really know the difference between it and JavaScript! But I absolutely "had to have it" according to all the experts.
